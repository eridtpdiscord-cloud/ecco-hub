...
local Window = ObsidianLibrary:CreateWindow({
	Title = "Ecco Hub V3",
	Footer = "https://discord.gg/hN9QpA3HA | Anime Astral Simulator",
	Icon = 18657887261,
...
local WEBHOOK_INVITE = "discord.gg/hN9QpA3HA"
...
SaveManager:SetFolder("EccoHubV3/astral-simulator")
